function header() {
  return `
    ...
    <div id="header1">
      ...
      />
      <div id="header1_product"  class="top" onclick="window.location.href='product.html'">Products</div>
      
      <div id="header1_concerns"  class="top" onclick="window.location.href='product.html'">Concerns</div>
      ...
      <div id="login_inner" class="top" onclick="window.location.href='./login.html'">Login</div>
    </div>
  </div>
